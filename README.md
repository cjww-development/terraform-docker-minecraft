...
| <a name="input_enable_autopause"></a> [enable\_autopause](#input\_enable\_autopause) | Enabling auto pause will pause the JVM process 1 hour after the last client has disconnected. | `bool` | n/a | yes |
